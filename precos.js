...
calculateButton.addEventListener('click', () => {
  ...
  if (inputValue>0) {
    ...
    resultElement.textContent = `O valor do pacote saira por: ${(calculatedValue).toLocaleString('pt-BR', {style: 'currency', currency: 'BRL'})}` ;
  } else {
...
calculateButton1.addEventListener('click', () => {
  ...
  if (inputValue1>0) {
    ...
    resultElement1.textContent = `O valor do pacote saira por: ${(calculatedValue1).toLocaleString('pt-BR', {style: 'currency', currency: 'BRL'})}` ;
  } else {
...
calculateButton2.addEventListener('click', () => {
  ...
  if (inputValue2>0) {
    ...
    resultElement2.textContent = `O valor do pacote saira por: ${(calculatedValue2).toLocaleString('pt-BR', {style: 'currency', currency: 'BRL'})}` ;
  } else {
